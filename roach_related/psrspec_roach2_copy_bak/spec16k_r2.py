...
bitstream='px4d16k_2016_Jan_21_1757.bof.gz' #16k spectral line backend
roach_board = 'roach2'
katcp_port = 7147
...
bandwidth = 320				# Bandwidth of the observing band (MHz), implies sampling rate is 2 * bandwidth
...
#                print('mark3')
	...
	def config_fpga(self):
		...
		self.fpga.write_int('reset', 1)
                print('gbe_overrun:')
                gbe_over=self.fpga.read_uint('fft_overrun1')
